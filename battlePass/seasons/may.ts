...
export const MAY_SEASON: IBattlePassSeason = {
    ...
    rewards:[
        ...
        new LuckyWheelReward("Прокрут колеса удачи", RewardRarity.COMMON, 'fortune', false),
        new ExpReward("Exp", RewardRarity.COMMON, 'exp', false, 3),
        new ClothReward("Венок святого патрика", RewardRarity.LEGENDARY, 'head1_m','head1_f', false, 'Вено святого патрика 1', 'Венок святого патрика F', 'Зеленый', 'Зеленый'),
        new CoinsReward("Коины", RewardRarity.COMMON, 'coins1', false, 100),
        new VipReward("Вип Diamond", RewardRarity.COMMON, 'vipD1', false, 'Diamond', 7),
         new MoneyReward("Деньги", RewardRarity.COMMON, 'money1', false, 30000),
        new ExpReward("Exp", RewardRarity.COMMON, 'exp', false, 6),
        new MoneyReward("Деньги", RewardRarity.COMMON, 'money1', false, 30000),
        new ClothReward("Маска Halk", RewardRarity.RARE, 'mask17_m','mask17_f', false, 'Маска Халк M', 'Маска Halk F', 'Зеленый', 'Зеленый',),
        new CoinsReward("Коины", RewardRarity.COMMON, 'coins1', false, 100),
        ...
        new LuckyWheelReward("Прокрут колеса удачи", RewardRarity.COMMON, 'fortune', false),
        new ClothReward("Шляпа святого патрика", RewardRarity.LEGENDARY, 'head4_m','head4_f', false, 'Шляпа святой патрик 1', 'Шляпа святого патрика F','Зеленый','Зеленый'),
        new VipReward("Вип Sapfire", RewardRarity.COMMON, 'vipS0', false, 'Sapfire', 5),
        new ExpReward("Exp", RewardRarity.COMMON, 'exp', false, 6),
        new CoinsReward("Коины", RewardRarity.COMMON, 'coins1', false, 100),
        ...
        new MoneyReward("Деньги", RewardRarity.COMMON, 'money0', false, 10000),
        new ClothReward("Nike Luxury Shoes", RewardRarity.LEGENDARY, 'sneakers6_m','sneakers6_f', false, 'Кеды Nike Luxury', 'Кроссовки Nike Luxury F','Фиолетовый','Фиолетовый'),
        ...
        new MoneyReward("Деньги", RewardRarity.COMMON, 'money0', false, 10000),
        new CoinsReward("Коины", RewardRarity.COMMON, 'coins0', false, 50),
        new ClothReward("Бандитская повязка назад", RewardRarity.RARE, 'head5_m','head5_f', false, 'Бандитская повязка назад 1', 'Бандитская бандана назад F', 'Черный', 'Черный'),
        ...
        new MoneyReward("Деньги", RewardRarity.COMMON, 'money0', false, 10000),
        new LuckyWheelReward("Прокрут колеса удачи", RewardRarity.COMMON, 'fortune', false),
        new ClothReward("Бандитская повязка вперед", RewardRarity.RARE, 'head2_m','head2_f', false, 'Бандитская повязка на перед 1', 'Бандитская бандана вперед F','Белый', 'Белый'),
        ...
        new InventoryItemReward("Феерверки", RewardRarity.RARE, 'fire1',  false, 868, 3),
        new ClothReward("Кроссовки Balenciaga", RewardRarity.RARE, 'sneakers5_m','sneakers5_f', false, 'Balenciaga Speed Trainers M', 'Balenciaga Speed Trainers F', 'Черный', 'Черный'),
