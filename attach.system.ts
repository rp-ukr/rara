export const WEAPON_ATTACH_LIST = {
    SHORT: [
        [24816, -0.115, -0.030, 0.200, 105, 181, 358],
        [24816, -0.050, 0.160, 0.060, 0, 182, 2],
        [24816, -0.095, 0.155, -0.090, 148, 180, 0],
        [24816, -0.140, 0.025, -0.205, 80, 180, 0],
        [51826, 0.130, 0.060, 0.090, 250, 0, 343],
        
    ],
    LONG: [
        [24818, 0.010, -0.135, 0.135, 184, 0, 185],
        [24818, 0.010, -0.155, -0.155, 180, 180, 0],
    ],
    BATON: [
        [57597, 0.180, 0.130, 0.140, 282, 354, 103]
    ],
    BAT: [
        [24818, 0.205, -0.130, 0.025, 354, 270, 7]
    ]
}

export const ATTACH_BONES_LIST:[string, number][] = [
    ["SKEL_ROOT", 0],
